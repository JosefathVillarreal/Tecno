    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        }catch(Exception e)
        {
           // System.out.println("com.papw.controllers.SelectUser.doGet() " + e.getMessage());
            ...
            session.setAttribute("valorarproducto", product);
            rD = request.getRequestDispatcher("ValorarProducto.jsp");
           ...
           // RequestDispatcher rd = request.getRequestDispatcher("detalleProducto.jsp");  
            request.getRequestDispatcher("ValorarProducto.jsp").forward(request, response);
