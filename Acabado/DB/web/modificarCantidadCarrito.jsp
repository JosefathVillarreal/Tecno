 ...
 <div class="topnav">
      ...
      <div class="card text-center" id="cartagrande">
          ...
          <div class="card-header" id="ParteDearribaDeLaLista">
            <h5>Modificar detalle de carrito de compra</h5>
          </div>
                  ...
                  <div class="card-body" id="contenidoDelasCartas">
                    ...
                    if(user!=null){
                        if(user.getPuesto().equals("Cliente")){
                            %>
                            <form action="modificaCantidadDetalleProducto?id<%= pc.getIdDetalleDeVenta()%>" method="POST" id="formIngresar"> 
                                <div class="text-center">
                                    <div class="card-body">
                                      
                                      <h5 class="card-title">Número del detalle de venta: <%= pc.getIdDetalleDeVenta()%></h5>
                                      <h5 class="card-title">Número del carrito: <%= pc.getId()%></h5>
                                      <p class="card-text">Usuario: <%= pc.getNombreusuario()%></p>
                                      <p class="card-text">Artículo: <%= pc.getNombrearticulo()%></p>
                                      <p class="card-text">Precio unitario: $ <%= pc.getPrecio()%></p>
                                      <p class="card-text">Cantidad: <%= pc.getCantidad()%></p>
                                      <p class="card-text">Nueva cantidad: </p>
                                      <input type="text" name="cantidad" id="formNombre" value="<%= pc.getCantidad()%>"><br><br><br>
                                      
                                      <!--
                                      
                                      -->
                                      <button id="BotonParaBuscar" type="submit"> Modificar cantidad </button>
                                      <hr>
                                    </div>
                                       <input type="text" name="idDelDetalle" value="<%= pc.getIdDetalleDeVenta()%>">
                                      <input type="text" name="idDeLaVenta" value="<%= pc.getId()%>">
                                </div>
