...
INSERT INTO `artÃ­culo` VALUES (1,'Unidad de Estado SÃ³lido Kingston A400 de 480 GB, 2.5\" SATA III (6Gb/s)','Disco Duro tipo unidad de estado sÃ³lido capacidad 480GB interfaz SATA III (6.0 Gb/s) factor de forma 2.5\"','2019-10-17 04:08:41',1099,100,2,1,1),(2,'Procesador Intel Core i7-8700','Octava GeneraciÃ³n, 3.2 GHz (hasta 4.6 GHz) con Intel UHD Graphics 630, Socket 1151, CachÃ© 12 MB, Six-Core, 14nm','2019-10-18 00:45:43',7399,200,2,1,1),(3,'Tarjeta de Video NVIDIA Gigabyte GeForce GTX 1060 Windforce OC','6GB GDDR5, 1xHDMI, 2xDVI, 1xDisplayPort, PCI Express x16 3.0','2019-10-18 00:50:41',4899,150,2,1,0),(4,'Bocinas Logitech Z906 Digital','AutÃ©ntico Sonido 5.1 Dolby Digital y DTS, CertificaciÃ³n THX, 500 Watts RMS de Poder total','2019-10-18 00:51:43',4299,50,3,1,1),(5,'Regulador Koblenz 1400VA/600W','con 8 contactos','2019-10-18 00:54:56',299,80,5,1,1),(6,'Kaspersky Anti-Virus 2019, 10 PCs, 1 AÃ±o','Tu protecciÃ³n comienza con la de tu PC. Es por eso que nuestra protecciÃ³n esencial para PC la protege de virus, ransomware, phishing, spyware, sitios web peligrosos y mucho mÃ¡s.','2019-10-18 04:35:47',49,20,6,1,1),(7,'Mini Mouse Rosa','Optico Inalambrico Logitech M187 USB Color rosa','2019-11-22 04:53:31',249,250,3,1,1),(8,'Mouse Pad Primus','PMP-10L Gaming Arena color morado','2019-11-22 04:59:37',369,50,3,1,0),(9,'Laptop Lenovo Legion Y730','Procesador Intel Core i5 8300H hasta 4 GHz Memoria de 8GB DDR4 Disco Duro de 1TB SSD de 128GB Pantalla de 15.6 LED Video GeForce GTX 1050 Ti Unidad Optica No Incluida SO Windows 10 Home 64 Bits','2019-11-24 04:24:47',21699,100,1,0,1),(10,'Memoria ADATA Premier','microSDHC UHS-1 de 32 GB, clase 10, incluye adaptador SD','2019-11-24 04:39:52',79,50,4,1,1),(11,'Eset Internet Security 2019','Para 1 Usuario te brinda la ultima tecnologiÃ‚Â­a de proteccion para tus actividades online en computadoras o smartphones.','2019-11-26 01:14:16',269,25,6,1,1),(12,'Audofinos Logitech','Audfonos con microfono blu','2019-11-26 20:01:36',2600,50,2,0,1);
...
INSERT INTO `cliente_compra_artÃ­culo` VALUES (3,1,1,1099,'1',0,0),(3,2,2,7399,'1',0,1),(3,3,1,1099,'4',0,1),(3,4,1,1099,'3',0,1),(3,10,1,1099,'2',0,1);
...
SET @Cliente = (SELECT Cliente_idCliente FROM cliente_compra_artÃ­culo ORDER BY IDClienteCompraArtÃ­culo DESC LIMIT 1);
SET @Articulo = (SELECT `ArtÃ­culo_idArtÃ­culo` FROM cliente_compra_artÃ­culo ORDER BY IDClienteCompraArtÃ­culo DESC LIMIT 1);
...
SET @idCompra= (SELECT IDClienteCompraArtÃ­culo FROM cliente_compra_artÃ­culo ORDER BY IDClienteCompraArtÃ­culo DESC LIMIT 1 ) + 1; 

INSERT INTO `mydb`.`cliente_compra_artÃ­culo` (`Cliente_idCliente`, `ArtÃ­culo_idArtÃ­culo`, `Tipo de pago_idTipo de pago`,
...
BEGIN
SELECT IDClienteCompraArtÃ­culo, usuario.Nickname 
FROM cliente_compra_artÃ­culo 
INNER JOIN usuario 
ON usuario.idUsuario = cliente_compra_artÃ­culo.Cliente_idCliente
WHERE PresupuestoOCarrito = 0 AND Activo = 1
ORDER BY IDClienteCompraArtÃ­culo;
