...
<div class="card text-center" id="cartagrande">
  ...
  <div class="card-body">
      ...
      <video width="100%" controls>
          <source src="" id="videouno" type="video/mp4">
      </video>
        
      <div>
          <img src="" alt="Avatar" style="width:40%;height:40%;border-radius: 50%;" id="imagenuno" onclick="actualizarimagenes()">
          <img src="" alt="Avatar" style="width:40%;height:40%;border-radius: 50%;" id="imagendos">
      </div>
      <form method="POST" action="agregarProducto">
          ...
          <div class="informacion" id="informacion">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nombreproducto" placeholder="Nombre" name="nombre">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1"  class="Etiqueta">Descripción</label>
                    <input type="text" class="form-control" id="descripcionproducto" placeholder="Descripcion" name="descripcion">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputEmail1"  class="Etiqueta">Precio</label>
                      <input type="text" class="form-control" id="precioproducto" placeholder="Precio" name="precio" >
                    </div>
              <div class="form-group">
                <label for="exampleInputEmail1"  class="Etiqueta">Unidades</label>
                <input type="text" class="form-control" id="unidadesproducto" placeholder="Unidades" name="unidades">
              </div>
              ...
              <label  class="Etiqueta">Fecha de registro</label>
                <input type="date" max="3000-12-31" id="fechaproducto" name="fecha"><br><br>
                        </button>
             <label  class="Etiqueta">Categoria</label>
              ...
              <div class="form-group">
                ...
                <label for="exampleInputFile"  id="etiquetas" class="Etiqueta">Video</label><input type="text" class="form-control" id="rutaavideo" placeholder="Nombre" name="rutavideo1"><br>
                <input type="file" id="archivovideo" name="Imagen"><br><br>
                
              </div>
          </div>       
          
          <button id="BotonParaBuscar">Agregar</button>
