...
//            statement.setInt(1, Activate);
    ...
    public User AgregarUsuarioConTodo(String userName, String apellidoP,  String apellidoM,  String telefono,  String direccion, String email, String Nickname, String password, String puesto, String rutaImagen, InputStream userImage){
        InitialContext iC = null;
        Context context = null;
        Connection con = null;
        ResultSet rS = null;
