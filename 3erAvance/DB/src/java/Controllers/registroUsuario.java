...
// <{IN FechaDeNacimiento DATETIME}>, <{IN TelefonoUsuario char(255)}>, <{IN DirecionUsuario VARCHAR(255)}>, 
 ...
 //<{IN Puesto VARCHAR(40)}>, <{IN Imagen BLOB}>,<{IN rutaImagen VARCHAR(255)}>);
        ...
        usuarioregistrado = usuarioaregistrar.AgregarUsuarioConTodo(username,apellidop,apellidom, telefono, dir, email, nick, password1, puesto, rutaImagen, file.getInputStream());
