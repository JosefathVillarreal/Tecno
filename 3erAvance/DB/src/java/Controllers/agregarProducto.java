...
public class agregarProducto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Product product; 
        Product productoaregistrar = new Product(); 
        
        productoaregistrar.AddProducto(nombre, descripcion, precio, unidades, categoria, estado, rutaimagen1, rutaimagen2, rutavideo);
