          ...
          <div class="informacion" id="informacion">
             ...
             <label  class="Etiqueta">Categoria</label>
              ...
              <div class="form-group">
                ...
                <input type="file" id="archivoimagenuno" name="Imagen" ><input type="text" class="form-control" id="rutaaimagen1" placeholder="Nombre" name="rutaimagen1" ><br>
                <label for="exampleInputFile"  id="etiquetas" class="Etiqueta" >Imagen2</label><br><br>
                <input type="file" id="archivoimagendos" name="Imagen" ><input type="text" class="form-control" id="rutaaimagen2" placeholder="Nombre" name="rutaimagen2" ><br>
                <label for="exampleInputFile"  id="etiquetas" class="Etiqueta" hidden>Video</label><input type="text" class="form-control" id="rutaavideo" placeholder="Nombre" name="rutavideo1" ><br>
