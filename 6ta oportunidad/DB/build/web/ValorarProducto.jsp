...
Product product = (Product)mySession.getAttribute("valorarproducto");
...
<div class="topnav">
    ...
    <div class="login-container">
        ...
        <img id="imagenavbar" src="css/images/img_snow_wide.jpg">
            ...
            <input type="text" placeholder="Puesto" name="puesto" id="formPuesto" value="">
...
<div class="card text-center" id="cartagrande">
  ...
  <div class="card-body">
      ...
      <form method="POST" action="valoraProducto?id=<%=product.getId()%>">
          <div class="informacion" id="informacion">
            <label class="Etiqueta">Like/Dislike</label>
              <select class="form-control" id="sel1" id="categoria" name="like">
                  <option value="0">No me gustó</option>   
                  <option value="1">Me gusta</option>   
              </select><br>
          <label class="Etiqueta">Comentario a agregar:</label>
          <input type="text" class="form-control" name="comentario">
          <br>
          <button type="submit" id="BotonParaBuscar">Valorar</button>
          </div>
       </form>
