...
<div class="card text-center" id="cartagrande">
  ...
  <div class="card-body">
      ...
      <form method="POST" action="modificaProducto?id=<%= product.getId()%>">
          <div class="informacion" id="informacion">
            
                <div class="form-group">
                  <label for="exampleInputEmail1"  class="Etiqueta">Producto</label>
                  <input type="text" class="form-control" id="nombreproducto" placeholder="Nombre" value="<%=product.getNombre()%>" name="nombre">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1"  class="Etiqueta">Descripción</label>
                    <input type="text" class="form-control" id="descripcionproducto" placeholder="Descripcion" value="<%=product.getDescripcion()%>" name="descripcion" >
                  </div>
                  <div class="form-group">
                      <label for="exampleInputEmail1"  class="Etiqueta">Precio</label>
                      <input type="text" class="form-control" id="precioproducto" placeholder="Precio" value="<%=product.getPrecio()%>" name="precio" >
                    </div>
              <div class="form-group">
                <label for="exampleInputEmail1"  class="Etiqueta">Unidades</label>
                <input type="text" class="form-control" id="unidadesproducto" placeholder="Unidades" value="<%=product.getUnidades()%>" name="unidades" >
              </div>
              <label  class="Etiqueta">Fecha de registro</label>
                <input type="date" max="3000-12-31" id="fechaproducto" value="<%=product.getFecha()%>" name="fecha" ><br><br>
                        </button>
             <label  class="Etiqueta">Categoria</label>
              <select class="form-control" id="sel1" id="categoria" name="categoria" name="categoria">
                        <%
                        for(Categoria c : categorias){
              ...
              <select class="form-control" id="sel1" id="categoria" name="estado" name="categoria">
              ...
              <div class="form-group">
                ...
                <input type="file" id="archivoimagenuno" name="Imagen" ><input type="text" class="form-control" id="rutaaimagen1" placeholder="Nombre" name="rutaimagen1" value="<%=product.getRuta()%>" ><br>
                <label for="exampleInputFile"  id="etiquetas" class="Etiqueta" >Imagen2</label><br><br>
                <input type="file" id="archivoimagendos" name="Imagen" ><input type="text" class="form-control" id="rutaaimagen2" placeholder="Nombre" name="rutaimagen2" <%=product.getRuta1()%>><br>
                <label for="exampleInputFile"  id="etiquetas" class="Etiqueta" hidden>Video</label><input type="text" class="form-control" id="rutaavideo" placeholder="Nombre" name="rutavideo1" value="<%=product.getVideo()%>"><br>
                <input type="file" id="archivovideo" name="Imagen" ><br><br>
              </div>
           
              <button id="BotonParaBuscar">Modificar</button>
