          ...
          <div class="card-body">
              <form method="POST" action="registroUsuario" enctype="multipart/form-data" id="agregarUsuario">
                  <div class="informacion" id="informacion">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1" class="Etiqueta">Contraseña(Minimo un número, una mayuscula y son mínimo 8 carácteres)</label>
                        <input type="password" class="form-control" id="password1" name="password1" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                      </div>

                      <div class="form-group">
                          <label for="exampleInputPassword1" class="Etiqueta">Confirmación de contraseña</label>
                          <input type="password" class="form-control" id="password2" name="password2" placeholder="Password"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                        </div>
