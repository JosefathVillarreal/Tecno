 ...
 * @author Josefath
 */
public class busquedaPorCategoria extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(user != null){
            if(user.getPuesto().equals("Administrador")){
                ...
                listaproducto = producto.ObtenerArticulosParaAdministradoresPorFiltroCategorias(id);
            }else{
                 //este usuario es cliente
                listaproducto = producto.GetAllProductParaUsuarioGenericoPorFiltro(id); 
            }
        }else{
            //este usuario es cliente
            listaproducto = producto.GetAllProductParaUsuarioGenericoPorFiltro(id); 
